 ...
 */
export type ResetCacheStrategy = 'close' | 'refresh';
 ...
 */
export type ThemeScrollMode = import('@sa/materials').LayoutScrollMode;
 ...
 * - button: button style
 */
export type ThemeTabMode = import('@sa/materials').PageTabMode;

/** Unocss animate key */
export type UnoCssAnimateKey =
  | 'pulse'
  | 'bounce'
  | 'spin'
  | 'ping'
