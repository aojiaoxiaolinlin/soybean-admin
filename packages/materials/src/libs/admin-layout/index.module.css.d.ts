declare const styles: {
  ...
  readonly 'layout-sidebar': string
  readonly 'layout-mobile-sidebar': string
  readonly 'layout-mobile-sidebar-mask': string
  readonly 'layout-sidebar_collapsed': string
  ...
  readonly 'sidebar-padding-top': string
  readonly 'sidebar-padding-bottom': string
};
